...
```
    ...
    ##                                    2.5 %    97.5 %
    ## (Intercept)          3.2740589 2.0759841 5.2121977
    ## victim_age           0.9930344 0.9866654 0.9993728
    ## victim_sexMale       0.4115656 0.3148182 0.5369411
    ## victim_racenon-white 0.4406080 0.3121625 0.6196693
...
confint(glm_Baltimore) %>% 
  broom::tidy() %>% 
  rename(term = .rownames, CI_lower = X2.5.., CI_higher = X97.5..) %>% 
  inner_join(glm_estimate) %>% 
  select(term, OR, CI_lower, CI_higher, everything())
```
    ...
    ## # A tibble: 4 x 6
    ##   term                    OR CI_lower CI_higher   log_OR  p.value
    ##   <chr>                <dbl>    <dbl>     <dbl>    <dbl>    <dbl>
    ## 1 (Intercept)          3.27    0.730   1.65      1.19    4.30e- 7
    ## 2 victim_age           0.993  -0.0134 -0.000627 -0.00699 3.22e- 2
    ## 3 victim_sexMale       0.412  -1.16   -0.622    -0.888   6.80e-11
    ## 4 victim_racenon-white 0.441  -1.16   -0.479    -0.820   2.68e- 6
